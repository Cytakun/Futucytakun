...
public class TileEntityEnergyextractor extends TileEntity implements ISidedInventory{
    ...
    public void updateEntity() {
        ...
        if (worldObj.getBlock(xCoord+1,yCoord,zCoord) == Futucytakun.Energystorer ||
                ...
                worldObj.getBlock(xCoord-1,yCoord,zCoord) == Futucytakun.Energystorer ||
                worldObj.getBlock(xCoord,yCoord-1,zCoord) == Futucytakun.Energystorer ||
                worldObj.getBlock(xCoord,yCoord,zCoord-1) == Futucytakun.Energystorer) {
        ...
        if (CK<10000) {
            ...
            if (Itemstack1!=null && Itemstack1.getItem()== Item.getItemFromBlock(Blocks.coal_block)) {
                CK=CK+1000;
                Itemstack1.stackSize--;
                if (Itemstack1.stackSize<=0) {
                    Itemstack1=null;
            ...
            if (Itemstack2!=null && Itemstack2.getItem()== Item.getItemFromBlock(Blocks.coal_block)) {
                CK=CK+1000;
                Itemstack2.stackSize--;
                if (Itemstack2.stackSize<=0) {
                    Itemstack2=null;
