 ...
 */
public class ContainerEnergystorer extends Container{
    @Override
    public boolean canInteractWith(EntityPlayer player) {
        return true;
    }

    public ContainerEnergystorer(InventoryPlayer player, TileEntity entity) {
        this.entity = entity;

        addSlotToContainer(new Slot((IInventory)entity, 0, 26, 22));
        addSlotToContainer(new Slot((IInventory)entity, 1, 62, 22));
